...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    const msg = {
      to: customerEmail,
      from: process.env.FROM_EMAIL || "noreply@georgiastride.com",
      subject: `Booking Confirmation - ${tourDetails.name}`,
      templateId: process.env.SENDGRID_TEMPLATE_ID, // Optional: Use SendGrid template
      dynamicTemplateData: {
        ...
        meeting_point:
          "We'll send you the exact meeting location 24 hours before your tour",
        guide_contact:
          "Your guide will contact you the day before with their details",
        support_email: "support@georgiastride.com",
        support_phone: "+995 555 123 456",
      },
      // Alternative: Use HTML directly instead of template
      html: `
        <!DOCTYPE html>
        <html>
        <head>
