  ...
  return (
    <div className="py-8 mt-20 min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-8 mb-8">
        <button
          className="bg-transparent border-none text-hipster-600 text-base font-semibold cursor-pointer py-2 transition-colors duration-300 hover:text-forest-700"
          onClick={onBack}
        >
          ← Back to Tours
        </button>
        ...
        <div className="lg:sticky lg:top-24 h-fit">
          <div className="bg-white rounded-3xl p-8 shadow-xl">
            <div className="text-center mb-8 pb-6 border-b border-gray-200">
              <span className="block text-4xl font-bold text-hipster-600">
                ${tour.price}
              </span>
            ...
            <div className="mb-8">
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full p-4 border-2 border-gray-200 rounded-xl text-base transition-colors duration-300 focus:outline-none focus:border-hipster-600"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center justify-center gap-4 border-2 border-gray-200 rounded-xl p-2">
                  <button
                    ...
                    className="bg-hipster-600 text-white border-none w-10 h-10 rounded-full text-xl font-bold cursor-pointer transition-all duration-300 hover:bg-forest-700 hover:scale-110"
                  >
                    -
                  </button>
              ...
              <div className="flex justify-between items-center py-4 border-t border-gray-200 mb-6 font-semibold text-gray-800">
                ...
                <span className="text-2xl text-hipster-600">
              ...
              <button
                className={`w-full py-4 px-8 rounded-xl text-base font-semibold cursor-pointer transition-all duration-300 uppercase tracking-wider ${
                  !selectedDate
                    ...
                    : "bg-gradient-to-r from-hipster-600 to-forest-700 text-white hover:-translate-y-0.5 hover:shadow-lg"
                }`}
