...
class EmailService {
  ...
  async sendConfirmationEmail(tourDetails, paymentDetails, customerEmail, customerName) {
    try {
  ...
  async sendEmailWithEmailJS(tourDetails, paymentDetails, customerEmail, customerName) {
  ...
  async collectCustomerEmail() {
    return new Promise((resolve) => {
      const email = prompt('Please enter your email address for booking confirmation:');
